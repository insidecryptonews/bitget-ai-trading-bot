...
class DashboardProReporter:
    ...
    def build(self, *, hours: int = 24) -> dict[str, Any]:
        ...
        sections: list[tuple[str, Callable[[], str]]] = [
            ...
            ("Phase 8 Candidate Validator", lambda: lab.phase8_candidate_validator(hours=max(hours, 720))),
            ("Phase 8 Cost Stress", lambda: lab.phase8_cost_stress(hours=max(hours, 720))),
            ...
            ("Cost Sensitivity", lambda: lab.bitget_cost_model_audit(hours=hours)),
