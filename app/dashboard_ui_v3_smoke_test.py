...
class DashboardUiV3SmokeTest:
    ...
    def to_text(self) -> str:
        ...
        checks = {
            ...
            "contains_operational_intelligence": 'id="operational-intelligence"' in html and "Operational Intelligence / Fase 7" in html,
            "contains_exit_policy_v3": "exitPolicyV3BacktestBtn" in html and "exit-policy-v3-backtest" in js,
            "contains_sudden_move_detector": "suddenMoveDetectorBtn" in html and "sudden-move-detector" in js,
            "contains_walk_forward_validator": "walkForwardValidatorBtn" in html and "walk-forward-validator" in js,
            "contains_candidate_promotion_v2": "candidatePromotionV2Btn" in html and "candidate-promotion-v2" in js,
            "contains_shadow_strategy_simulator": "shadowStrategySimulatorBtn" in html and "shadow-strategy-simulator" in js,
            "contains_strategy_research_library": "strategyResearchLibraryBtn" in html and "strategy-research-library" in js,
            ...
            "contains_label_quality_v2": "labelQualityV2Btn" in html and "label-quality-v2" in js,
            "contains_cost_model_audit": "bitgetCostModelAuditBtn" in html and "bitget-cost-model-audit" in js,
            "contains_margin_mode_audit": "marginModeAuditBtn" in html and "margin-mode-audit" in js,
