# BitgetBot - Bybit Public Liquidations Collector loop (ResearchOps V10.31) - VISIBLE console
...
$host.UI.RawUI.WindowTitle = "BitgetBot Bybit Liquidations (ALTERNATIVE SOURCE - RESEARCH ONLY - NO LIVE)"
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host " BitgetBot - Colector Bybit de liquidaciones (V10.30/V10.31)" -ForegroundColor Cyan
